defmodule Etherscan.API.Transactions do
  ...
  """
  @spec get_contract_execution_status(transaction_hash :: String.t(), network :: String.t()) ::
          {:ok, ContractStatus.t()} | {:error, atom()}
  def get_contract_execution_status(transaction_hash, network \\ :default)
  def get_contract_execution_status(transaction_hash, network) when is_address(transaction_hash) do
    "transaction"
    |> get("getstatus", %{txhash: transaction_hash}, network)
    |> parse(as: %{"result" => %ContractStatus{}})
    |> wrap(:ok)
  end

  def get_contract_execution_status(_, _), do: @error_invalid_transaction_hash
  ...
  """
  @spec get_transaction_receipt_status(transaction_hash :: String.t(), network :: String.t()) ::
          {:ok, any()} | {:error, atom()}
  def get_transaction_receipt_status(transaction_hash, network \\ :default)
  def get_transaction_receipt_status(transaction_hash, network) when is_address(transaction_hash) do
    "transaction"
    |> get("gettxreceiptstatus", %{txhash: transaction_hash}, network)
    |> parse()
    |> wrap(:ok)
  end

  def get_transaction_receipt_status(_, _), do: @error_invalid_transaction_hash
end
